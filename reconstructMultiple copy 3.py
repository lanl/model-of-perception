...
def optimize_iso_vals_gd(rho, dims, iso_init, steps=20, lr=0.1):
...
def main():
    ...
    parser.add_argument("--gd-steps", type=int, default=10, help="GD steps for iso optimization")
    ...
    if args.optimize_gd:
        ...
        iso_vals, recon_field = optimize_iso_vals_gd(rho, dims, iso_vals, steps=args.gd_steps, lr=args.gd_lr)
        ...
        # (Optional) keep signed fields for inspection; reconstruction already stored from proxy
